    ...
    <Layout>
      ...
      <section className="w-3/4 mx-auto flex flex-col gap-10">
        ...
        <form className="flex flex-col gap-5">
          ...
          <div className="input-button">
            <button className={styles.button_custom} type="button">SignIN with Google</button>
          </div>
          <div className="input-button">
            <button onClick={handleGithubSignin} className={styles.button_custom} type="submit">SignIN with GitHub</button>
          </div>
        </form>
